		...
		c = function() {
			...
			return a(t, [{
				...
				value: function(t) {
					...
					this.width < 800 ? (this.largeTextSize = 18, this.smallTextSize = 16) : (this.largeTextSize = 26, this.smallTextSize = 22),
		...
		d = function() {
			...
			return a(t, [{
				...
				value: function() {
					...
					this.baseline.test = this.baseline.training - 13 * this.ballSpacing;
